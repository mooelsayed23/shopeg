...
const categories = [
  { icon: "/assets/images/icons/dress.svg", title: "Dress & frock", amount: "(53)" },
  { icon: "/assets/images/icons/coat.svg", title: "Winter wear", amount: "(58)" },
  { icon: "/assets/images/icons/glasses.svg", title: "Glasses & lens", amount: "(68)" },
  { icon: "/assets/images/icons/shorts.svg", title: "Shorts & jeans", amount: "(84)" },
      ...
      <div className=" w-full">
        <div className="category-item-container has-scrollbar columns-4">
          ...
          {categories.map((category, index) => (
            <div className="category-item flex border border-[#ededed] rounded-[10px] items-center w-full p-4 gap-4 mb-5" key={index}>
              ...
              <div className="category-content-box flex flex-col w-full">
                <div className="category-content-flex flex justify-between grow w-full items-center">
                  <h3 className="category-item-title font-bold">{category.title}</h3>
                  <p className="category-item-amount text-xs">{category.amount}</p>
                </div>
                <a href="#" className="category-btn text-pink-500 font-semibold">Show all</a>
              </div>
            </div>
          ))}
        </div>
