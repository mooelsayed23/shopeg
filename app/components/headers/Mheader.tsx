...
const Mheader = () => {
  return (
    <>
      <div className="header-main border-b sm:py-3">
        <div className="container flex flex-col sm:flex-row grow justify-evenly  items-center m-auto">
          ...
          <div className="header-search-container border rounded-md flex items-center px-4  ">
            <input
              type="search"
              name="search"
              className="search-field grow sm:min-w-72 py-2.5 outline-none"
