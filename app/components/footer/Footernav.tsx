        ...
        <ul className="footer-nav-list w-1/5 mb-10" key={index}>
          ...
          {list.links &&
            list.links.map((link, idx) => (
              <li className="footer-nav-item" key={idx}>
                <a href="#" className="footer-nav-link text-sm mb-3">
                  {link}
                </a>
              </li>
            ))}
          {list.info && (
            <li className="footer-nav-item flex items-start">
              <div className="icon-box text-2xl mr-2">
                <IoLocationOutline />
              </div>
              <address className="content text-sm text-wrap ">
                {list.info}
              </address>
            </li>
          )}
          {list.phone && (
            <li className="footer-nav-item flex items-center">
              ...
              <a
                href={`tel:${list.phone}`}
                className="footer-nav-link text-sm my-3"
              >
                {list.phone}
              </a>
            </li>
          ...
          {list.email && (
            <li className="footer-nav-item flex items-center">
              ...
              <a
                ...
                className="footer-nav-link text-justify text-sm"
              >
                {list.email}
              </a>
            </li>
